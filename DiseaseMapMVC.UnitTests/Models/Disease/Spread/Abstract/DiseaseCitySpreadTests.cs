...
namespace DiseaseMapMVC.UnitTests
{
    ...
    public class DiseaseCitySpreadTests
    {
        ...
        [Test]
        public void GetSickDurationDayEarlier_DiseaseStatisticIsLessThanDiseaseDuration_ReturnZero()
        {
            var peopleNumber = _parameterSetter.GetPeopleNumber();
            ...
            var sickEarlier = citySpread.GetSickDurationDayEarlier();

            Assert.Zero(sickEarlier);
        }

        [Test]
        public void GetSickDurationDayEarlier_DiseaseStatisticIsEqualDiseaseDuration_ReturnDurationStartDaySick()
        {
            var peopleNumber = _parameterSetter.GetPeopleNumber();
            ...
            Assert.AreEqual(sickEarlier, durationStartDayStatistic.Sick);
        }

        [Test]
        public void GetSickDurationDayEarlier_DiseaseStatisticIsMoreThanDiseaseDuration_ReturnDurationStartDaySickMinusPreviousDaySick()
        {
            var peopleNumber = _parameterSetter.GetPeopleNumber();
            ...
            Assert.AreEqual(sickEarlier, expectedSickInDurationDay);
        }
